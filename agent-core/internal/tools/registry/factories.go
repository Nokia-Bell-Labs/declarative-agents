...
func StandardFactoryCatalog(deps StandardFactoryDeps) []StandardFactoryCatalogEntry {
	return []StandardFactoryCatalogEntry{
		...
		hookFactory("planning", []string{"load_graph", "extract_task", "extract_all", "assemble_prompt", "parse_plan", "format_issue", "record_tracker_issue", "create_issue", "execute_task", "check_result"}, deps.RegisterPlanning),
