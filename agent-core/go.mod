...
require (
	github.com/Nokia-Bell-Labs/declarative-agents/magefiles v0.0.0-20260917222628-140b8b5c3b12
...
replace github.com/Nokia-Bell-Labs/declarative-agents/magefiles v0.0.0-20260917222628-140b8b5c3b12 => ../magefiles
