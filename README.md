...
| [`application-dsl-spec/`](application-dsl-spec/) | *Libretto*, the normative specification of the application DSL — numbered statements in `language.yaml` with acceptance evidence, prose chapters that cite them, and a render/audit pipeline. Rendered at [nokia-bell-labs.github.io/declarative-agents](https://nokia-bell-labs.github.io/declarative-agents/). |
