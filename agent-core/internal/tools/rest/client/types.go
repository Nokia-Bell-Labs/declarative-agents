...
import "github.com/Nokia-Bell-Labs/declarative-agents/agent-core/internal/tools/rest/credentials"
...
// CredentialResolver is the credentials package resolver, so client commands
// accept the same values rest aliases.
