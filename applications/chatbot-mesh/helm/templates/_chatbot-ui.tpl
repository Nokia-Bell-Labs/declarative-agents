...
version: 2
# The shell renders its sidebar and routes from these panels and mounts each
# from the registry in app/src/panels.ts (applications srd004 R5, R7). The
# last URL segment selects the panel, so /ui/observability deep-links as before.
panels:
  - id: chat
    package: local
    route: /chat
