...
| [`application-dsl-spec/`](application-dsl-spec/) | Normative specification of the application DSL — numbered statements in `language.yaml` with acceptance evidence, prose chapters that cite them, and a render/audit pipeline. |
